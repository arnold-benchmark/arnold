...
class OneStreamTransportLangFusion(TwoStreamTransportLangFusion):
    ...
    def __init__(self, stream_fcn, in_shape, n_rotations, crop_size, preprocess, cfg, device, z_roll_pitch=False):
        self.fusion_type = cfg['train']['trans_stream_fusion_type']
        super().__init__(stream_fcn, in_shape, n_rotations, crop_size, preprocess, cfg, device, z_roll_pitch=z_roll_pitch)
