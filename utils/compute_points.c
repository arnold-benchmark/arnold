...
static PyObject *__pyx_n_s_compute_points;
static PyObject *__pyx_kp_s_compute_points_pyx;
...
static PyObject *__pyx_n_s_points_cam;
...
/* Python wrapper */
static PyObject *__pyx_pw_14compute_points_1compute_points(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyMethodDef __pyx_mdef_14compute_points_1compute_points = {"compute_points", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_14compute_points_1compute_points, METH_VARARGS|METH_KEYWORDS, 0};
static PyObject *__pyx_pw_14compute_points_1compute_points(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  int __pyx_v_height;
  int __pyx_v_width;
  ...
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_height,&__pyx_n_s_width,&__pyx_n_s_depth,&__pyx_n_s_fx,&__pyx_n_s_fy,&__pyx_n_s_cx,&__pyx_n_s_cy,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_width)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("compute_points", 1, 7, 7, 1); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (likely((values[2] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_depth)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_points", 1, 7, 7, 2); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  3:
        if (likely((values[3] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fx)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_points", 1, 7, 7, 3); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  4:
        if (likely((values[4] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_fy)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_points", 1, 7, 7, 4); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  5:
        if (likely((values[5] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cx)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_points", 1, 7, 7, 5); __PYX_ERR(0, 7, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (likely((values[6] = __Pyx_PyDict_GetItemStr(__pyx_kwds, __pyx_n_s_cy)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("compute_points", 1, 7, 7, 6); __PYX_ERR(0, 7, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "compute_points") < 0)) __PYX_ERR(0, 7, __pyx_L3_error)
      }
  ...
  __Pyx_RaiseArgtupleInvalid("compute_points", 1, 7, 7, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 7, __pyx_L3_error)
  __pyx_L3_error:;
 ...
 */
                                  ...
                                  __pyx_t_13 = __pyx_v_u;
                                  __pyx_t_15 = 0;
                                  *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_result_view.data + __pyx_t_14 * __pyx_v_result_view.strides[0]) ) + __pyx_t_13 * __pyx_v_result_view.strides[1]) ) + __pyx_t_15 * __pyx_v_result_view.strides[2]) )) = (__pyx_t_16 / __pyx_v_fx);
 ...
 */
                                  ...
                                  __pyx_t_13 = __pyx_v_u;
                                  __pyx_t_15 = 1;
                                  *((double *) ( /* dim=2 */ (( /* dim=1 */ (( /* dim=0 */ (__pyx_v_result_view.data + __pyx_t_14 * __pyx_v_result_view.strides[0]) ) + __pyx_t_13 * __pyx_v_result_view.strides[1]) ) + __pyx_t_15 * __pyx_v_result_view.strides[2]) )) = (__pyx_t_16 / __pyx_v_fy);
                                }
                                goto __pyx_L17;
                                __pyx_L12_error:;
                                {
 ...
 *     cdef double[:, :, :] result_view = points_cam
 */
  __pyx_tuple__20 = PyTuple_Pack(13, __pyx_n_s_height, __pyx_n_s_width, __pyx_n_s_depth, __pyx_n_s_fx, __pyx_n_s_fy, __pyx_n_s_cx, __pyx_n_s_cy, __pyx_n_s_points_cam, __pyx_n_s_result_view, __pyx_n_s_v, __pyx_n_s_u, __pyx_n_s_k, __pyx_n_s_d); if (unlikely(!__pyx_tuple__20)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__20);
  __Pyx_GIVEREF(__pyx_tuple__20);
  __pyx_codeobj__21 = (PyObject*)__Pyx_PyCode_New(7, 0, 13, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__20, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_compute_points_pyx, __pyx_n_s_compute_points, 7, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__21)) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 *     cdef double[:, :, :] result_view = points_cam
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_14compute_points_1compute_points, NULL, __pyx_n_s_compute_points); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_compute_points, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
